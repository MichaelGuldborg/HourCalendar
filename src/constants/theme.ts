export const theme = {
    ...
    colors: {
        ...
        primary: '#484dff', // primary button and link color
    ...
    buttons: {
        ...
        // you can reference other values defined in the constants
        default: {
    ...
    styles: {
        // To add base, top-level styles to the <body> element, use constants.styles.root.
        root: {
            fontFamily: 'body',
            lineHeight: 'body',
            fontWeight: 'body',
